...
if __name__ == "__main__":
    # Simple Product
    simple_product = SimpleProduct("SP01", "Pencil", 05, 30)
    print("Total value of Simple Product:", simple_product.calculate_value())

    # Perishable Product
    expiry_date = datetime(2024, 3, 22)  # March 22nd, 2024
    perishable_product = PerishableProduct("PP01", "Apple", 22, 04, expiry_date)
    print("Total value of Perishable Product:", perishable_product.calculate_value())

    # Digital Product
    digital_product = DigitalProduct("DP01", "Application", 12, 10)
